...
class DomainListDetail(BaseModel):
    """
    DomainListDetail
    """ # noqa: E501
    status: StrictStr = Field(description="Status.")
    data: List[DomainDataDetail]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "data": [DomainDataDetail.from_dict(_item) for _item in obj["data"]] if obj.get("data") is not None else None
        })
        return _obj

...
class ReplaceDocumentsRequest(BaseModel):
    ...
    """ # noqa: E501
    domain: Optional[StrictStr] = Field(default=None, description="The name of a group of documents. Defaults to \"default\".")
    documents: List[Document] = Field(description="List of documents to replace.")
    __properties: ClassVar[List[str]] = ["domain", "documents"]

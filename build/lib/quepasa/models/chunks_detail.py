...
class ChunksDetail(BaseModel):
    """
    ChunksDetail
    """ # noqa: E501
    status: Optional[StrictStr] = Field(default=None, description="Status.")
    data: Optional[List[ChunksDetailDataInner]] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "data": [ChunksDetailDataInner.from_dict(_item) for _item in obj["data"]] if obj.get("data") is not None else None
        })
        return _obj
